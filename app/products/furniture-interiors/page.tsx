...
export const metadata: Metadata = {
  title: 'Furniture & Interiors : Build360.online',
  description: 'Office seating, ergonomic chairs, and workspace furniture from Rockworth — sourced in bulk for businesses.',
};
...
const categories = [
  {
    ...
    banner: '/images/furniture/office-seating.jpg',
    description: 'Ergonomic and task chairs from Rockworth for modern, productive workspaces.',
    brands: [
      {
        name: 'Rockworth',
        href: '/products/rockworth',
        description: 'Certified ergonomic seating and task chairs — executive, mesh, and space-saver lines.',
      },
    ],
  },
];

export default function FurnitureInteriorsPage() {
  return (
    <>
      <section className="min-h-[35vh] flex items-center text-center px-[var(--gutter)] relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, #3B2A1A 0%, #241A0E 50%, #3B2A1A 100%)' }}
      >
        <div className="mx-auto max-w-3xl w-full pt-[60px] pb-16">
          ...
          <h1 className="font-serif text-[clamp(32px,5vw,52px)] font-extrabold leading-[1] tracking-[-0.02em] uppercase text-white mb-4">
            Workspaces That{' '}
            <em className="not-italic text-[var(--color-primary)]">Work for You.</em>
          </h1>
          <p className="text-sm md:text-base text-[var(--color-text-secondary)] max-w-xl mx-auto leading-relaxed font-light">
            Ergonomic office furniture and seating sourced in bulk for businesses of every size.
          </p>
        </div>
      </section>
