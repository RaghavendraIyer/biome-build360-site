...
export const metadata: Metadata = {
  title: 'UltraTech Tilefixo : Build360.online',
  description: 'UltraTech Tilefixo tile adhesives, epoxy grouts, spot bonding, and cleaners — source in bulk.',
};

const brand = brands.find((b) => b.id === 'ultratech')!;
const brandProducts = products.filter((p) => p.brand === 'ultratech');
