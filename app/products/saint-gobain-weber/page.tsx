...
export const metadata: Metadata = {
  title: 'Saint Gobain Weber : Build360.online',
  description: 'Saint Gobain Weber tile adhesives and grouts — source in bulk from Build360.',
};

const brand = brands.find((b) => b.id === 'weber')!;
const brandProducts = products.filter((p) => p.brand === 'weber');
