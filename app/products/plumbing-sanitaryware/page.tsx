...
export const metadata: Metadata = {
  title: 'Plumbing & Sanitaryware : Build360.online',
  description: 'Sanitaryware, faucets, showers, and bathroom fittings from Hindware — sourced in bulk.',
};
...
const categories = [
  {
    id: 'sanitaryware',
    label: 'Sanitaryware',
    banner: '/images/plumbing/sanitaryware.jpg',
    description: 'Toilets, basins, urinals, and bathtubs — engineered for durability and Italian design.',
    brands: [
      {
        name: 'Hindware',
        href: '/products/hindware#sanitaryware',
        description: 'One-piece, coupled, and wall-hung toilets; concealed cisterns; basins; urinals; and bathtubs.',
      },
    ],
  },
  {
    id: 'bath-fittings',
    label: 'Bath & Kitchen Fittings',
    banner: '/images/plumbing/bath-fittings.jpg',
    description: 'Faucets, mixers, showers, and accessories in chrome, black, and gold finishes.',
    brands: [
      {
        name: 'Hindware',
        href: '/products/hindware#bath-fittings',
        description: 'Basin and kitchen mixers, multi-function showers, thermostats, and shower enclosures.',
      },
    ],
  },
];

export default function PlumbingSanitarywarePage() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-3xl w-full pt-[60px] pb-16">
          ...
          <h1 className="font-serif text-[clamp(32px,5vw,52px)] font-extrabold leading-[1] tracking-[-0.02em] uppercase text-white mb-4">
            Bathrooms That{' '}
            <em className="not-italic text-[var(--color-primary)]">Elevate the Everyday.</em>
          </h1>
          <p className="text-sm md:text-base text-[var(--color-text-secondary)] max-w-xl mx-auto leading-relaxed font-light">
            Sanitaryware, faucets, and showers from Hindware&apos;s Italian Collection — for premium bathrooms.
          </p>
        </div>
      </section>
