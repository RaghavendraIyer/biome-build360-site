...
export const metadata: Metadata = {
  title: 'Waterproofing & Sealants : Build360.online',
  description: 'WeatherPro and Aquastop waterproofing systems, sealants, and coatings from UltraTech BPD and Kerakoll.',
};
...
const categories = [
  {
    ...
    banner: '/images/waterproofing/systems.jpg',
    description: 'Preventive and repair waterproofing — membranes, acrylic coats, and SBR latex from trusted brands.',
    brands: [
      {
        name: 'UltraTech BPD',
        href: '/products/ultratech-bpd#waterproofing',
        description: 'WeatherPro Flex, Hi-Flex, WP+ 200, Top-Shield, POP-Shield, Bitupo, Seal & Dry, and bathroom kits.',
      },
      {
        name: 'Kerakoll',
        href: '/products/kerakoll',
        description: 'Aquastop range — Nanoflex, P6, Flex, AR1, and 120 liquid waterproofing membranes.',
      },
    ],
  },
];

export default function WaterproofingSealantsPage() {
  return (
    <>
      <section className="min-h-[35vh] flex items-center text-center px-[var(--gutter)] relative overflow-hidden"
        style={{ background: 'linear-gradient(135deg, #1A3D57 0%, #0B2030 50%, #1A3D57 100%)' }}
      >
        <div className="mx-auto max-w-3xl w-full pt-[60px] pb-16">
          ...
          <h1 className="font-serif text-[clamp(32px,5vw,52px)] font-extrabold leading-[1] tracking-[-0.02em] uppercase text-white mb-4">
            One Chance to Get{' '}
            <em className="not-italic text-[var(--color-primary)]">Waterproofing Right.</em>
          </h1>
          <p className="text-sm md:text-base text-[var(--color-text-secondary)] max-w-xl mx-auto leading-relaxed font-light">
            Roof, terrace, bathroom, and wet-area waterproofing systems from UltraTech BPD and Kerakoll.
          </p>
        </div>
      </section>
