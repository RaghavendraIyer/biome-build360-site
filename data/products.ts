...
export const products: Product[] = [
  ...
  { id: 'ultima-plus', brand: 'ultratech', name: 'Ultima Plus', description: 'Ultra-premium adhesive with enhanced flexibility and bonding strength.', image: '/adhesives/ultima-plus.jpg', specs: { Grade: 'Ultra Premium', Application: 'All Substrates' } },
  { id: 'style-2k', brand: 'ultratech', name: 'STYLE 2K Epoxy Grout', description: 'Two-component epoxy grout for stain-resistant, durable joints.', specs: { Grade: 'Epoxy', Application: 'Floor & Wall Grout' } },
  { id: 'style-3k', brand: 'ultratech', name: 'STYLE Epoxy Grout (3K)', description: 'Three-component epoxy system for commercial-grade grouting.', specs: { Grade: 'Epoxy', Application: 'Commercial Grout' } },
  { id: 'grout-cg', brand: 'ultratech', name: 'Grout CG', description: 'Cementitious grout for standard tile joint filling.', specs: { Grade: 'Standard', Application: 'Joint Filling' } },
  { id: 'tilefixo-rapid', brand: 'ultratech', name: 'Tilefixo Rapid', description: 'Fast-setting tile adhesive for quick turnaround projects.', specs: { Grade: 'Rapid Set', Application: 'Fast Track' } },
