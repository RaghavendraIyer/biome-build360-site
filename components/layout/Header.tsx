      ...
      <div className="mx-auto grid grid-cols-[auto_1fr_auto] gap-x-8 items-center px-[var(--gutter)] h-16 md:h-20">
        ...
        <div className="hidden lg:flex items-center gap-3">
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-[#25D366] rounded-[var(--radius)] hover:bg-[#1DA851] transition-colors no-underline"
          >
