...
const categories: Category[] = [
  ...
  },
  {
    ...
    desc: 'Heat pumps, water softeners, RO plants, pressure pumps, and geysers from verified manufacturers.',
    href: '/products/water-treatment',
    badge: '5 Product Lines',
    status: 'live',
  ...
  },
  {
    ...
    desc: 'Industrial and commercial gensets and solar power backup solutions.',
